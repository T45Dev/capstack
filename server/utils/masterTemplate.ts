...
export const MASTER_TABS: MasterTab[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { header: 'Quantity', key: 'quantity', format: 'number', help: 'Options currently outstanding for this grant. Commas OK.' },
      ...
      // Lifecycle (Issued grants only) — drives the Option Pool Impact timeline.
      { header: 'Quantity issued', key: 'quantity_issued', format: 'number', help: 'Original grant size. Defaults to Quantity if blank.' },
      { header: 'Quantity exercised', key: 'quantity_exercised', format: 'number', help: 'Shares exercised so far (optional).' },
      { header: 'Quantity forfeited', key: 'quantity_forfeited', format: 'number', help: 'Shares forfeited / cancelled on termination (optional).' },
      { header: 'Quantity expired', key: 'quantity_expired', format: 'number', help: 'Vested shares that lapsed unexercised (optional).' },
      { header: 'Last exercised date', key: 'last_exercised_date', format: 'YYYY-MM-DD', help: 'Anchors the exercise event on the pool timeline (optional).' },
      { header: 'Forfeited date', key: 'forfeited_date', format: 'YYYY-MM-DD', help: 'Termination date — anchors the forfeit event (optional).' },
      { header: 'Expired date', key: 'expired_date', format: 'YYYY-MM-DD', help: 'Anchors the expiration event (optional).' },
      { header: 'Acceleration', key: 'acceleration', values: ['single', 'double'], help: 'Change-of-control trigger (optional).' },
    ],
  },
  {
    sheet: 'Convertibles',
